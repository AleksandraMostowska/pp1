...
# c. A function that returns the median of numbers in an array. Do not use built-in functions. The median is the middle value 
# in the ordered sequence of numbers: https://en.wikipedia.org/wiki/Median#/media/File:Finding_the_median.png
